...
public class CircularAnimatedDrawable extends Drawable implements Animatable {
    ...
    private static CircularAnimatedDrawable drawable;
    ...
    private CircularAnimatedDrawable(int color, float borderWidth) {
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        fBounds.left = (float) (centerX - 30 + mBorderWidth / 2f + .5f);
        fBounds.right = (float) (centerX + 30 - mBorderWidth / 2f - .5f);
        fBounds.top = (float) (centerY - 30 + mBorderWidth / 2f + .5f);
        fBounds.bottom = (float) (centerY + 30 - mBorderWidth / 2f - .5f);
    }
    ...
    public static CircularAnimatedDrawable getInstance(int color, int i) {

//        if(drawable == null)
            drawable = new CircularAnimatedDrawable(color, i);
        return drawable;
    }
}